...
DEPENDENCES="aspell enchant gettext gspell gvfs hspell hunspell libvoikko nuspell" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
BIN_REMOVED="gcc"
LIB_REMOVED="gcc gconv libgallium perl hunspell/ myspell/"
PYTHON_REMOVED="__pycache__/"
SHARE_REMOVED="gcc gir i18n perl icons/AdwaitaLegacy icons/Adwaita/cursors/ terminfo"
...
mountpoint_files=""
mountpoint_dirs="/usr/share/hunspell /usr/share/myspell"
